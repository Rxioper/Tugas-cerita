...
<body >
    <fieldset>
    <h1><b><i>Tempat Wisata Yogyakarta</i></b></h1>
    <form action="" method="post">
        ...
        ?>
         ...
         <?php }elseif($destinasi == "7"){ ?>
                  ...
                  <table cellpadding="6">
                    <tr>
                      <th colspan="2" ><b><i>Menu</i></b></th>
                    </tr>
                    <tr>
                      <th><b><i>Daftar Makanan</i></b></th>
                      <th><b><i>Harga</i></b></th>
                    </tr>
                    <tr>
                      <td>japati Geprek</td>
                  ...
                  <div  class="cafe">
                        <select name="pilih">
                        <option selected>--Menu Makan dan Minum--</option>
                        <option value="1">japati Geprek</option>
                        <option value="2">Pecel Hiu</option>
                        <option value="3">lalab sampe</option>
                        <option value="4">Air putih rasa coklat</option>
                        <option value="5">teh pait</option>
                        <option value="6">kopi</option>
                      </select>
